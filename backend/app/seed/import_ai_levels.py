...
LEVEL_IMPORTS = [
    {
        ...
        "review_file": "qwen_judged_lessons_accepted_text_descriptions_review.json",
    ...
    },
    {
        ...
        "review_file": "qwen_judged_lessons_level2_accepted_text_descriptions_review.json",
    ...
    },
    {
        ...
        "review_file": "qwen_judged_lessons_level3_accepted_text_descriptions_review.json",
    ...
    for item in LEVEL_IMPORTS:
        result = await import_content(
            SimpleNamespace(
                ...
                review_file=str(outputs_dir / item["review_file"]),
