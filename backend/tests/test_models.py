...
def test_learning_attempt_stores_word_results_for_reports() -> None:
    assert "word_results" in LearningAttempt.__table__.columns
...
def test_unique_constraints_are_configured() -> None:
    ...
    assert {
        "uq_parents_kakao_id",
        "uq_reading_chunks_book_chapter_step",
        "uq_repeat_questions_book_chapter_step",
        "uq_description_questions_book_chapter_step",
        "uq_user_book_progress_profile_book",
        "uq_review_cards_profile_book_chapter_question",
        "uq_profile_customizations_profile_id",
